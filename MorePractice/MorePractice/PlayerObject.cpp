...
PlayerObject::PlayerObject(BulletManager *a_pBulletManager, GLuint a_uiVBO, GLuint a_uiIBO, GLSLProgram *a_pShader) : ShipObject(PLAYER_F_FIRE_COOL_DOWN_MAX, a_pBulletManager, a_uiVBO, a_uiIBO, a_pShader)
{
...
glm::vec3 PlayerObject::GetPosition() const
{
	PhysicsComponent* physicsComponent = dynamic_cast<PhysicsComponent*>(GameObject::GetComponent(PHYSICS));
	if (physicsComponent != nullptr) {
